-- Eliminar función existente y recrearla con nuevo parámetro de salida
DROP FUNCTION IF EXISTS public.consultar_cumplimiento_operario(text, date, date);
...
BEGIN
  ...
  -- Ahora incluye todos los registros donde operario_id = v_operario_id (tanto operario como ayudante)
